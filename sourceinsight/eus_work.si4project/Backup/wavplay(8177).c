...
void get_wave_head(ENUM_WAVE_TYPES wav_type)
{
    switch(wav_type)
    {
...
uint8_t wav_decode_init(ENUM_WAVE_TYPES wav_type,__wavctrl* wavx)
{
	...
	ChunkFACT *fact;
	ChunkDATA *data;
// 仅用于编程查看需要，后面需要删除 ---> 2022-7-21
extern uint8_t *wave_file_head;
extern uint8_t *wave_play_buf1;
extern uint8_t *wave_play_buf2;
